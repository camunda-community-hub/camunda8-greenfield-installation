...
metrics:
	...
	kubectl apply -f ./grafana-secret.yml -n default
	...
	kubectl apply -f ./grafana-load-balancer.yml -n default

.PHONY: clean-metrics
clean-metrics:
	-kubectl delete -f ./grafana-load-balancer.yml -n default
	-helm uninstall metrics --namespace default
	-kubectl delete -f ./grafana-secret.yml -n default
